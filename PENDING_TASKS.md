...
- **12/09/2026 — Exercices Avoir A1-E-019 & A1-E-020 PUBLIÉS** (`french/a1/02-avoir/exercice-formes.html` + `exercice-possession.html`, moteur LeoPick/LeoOral des modèles Être A1-E-017/018). Ordre : ex1=A1-E-019, ex2=A1-E-020, **ex3=A1-E-002 conservé**. `catalog.json` : liens bidirectionnels A1-L-002 ↔ 019/020, publie:true. 23 audios d'exercice (`avoir_x1_c1..c4`, `avoir_x2_*`) enregistrés + déployés ; **5 audios EN de la leçon** (ln1_en, ln2_en, lz1_en, lz2_en, s_ils_peur_en) enfin enregistrés + déployés ; 2 audios leçon retravaillés (`avoir_l_n_silent_en`, `avoir_l_m_nous_avons_en`) redéployés avec cache-buster `?v=2`. check_site = 0 erreur, vérifié en ligne.
